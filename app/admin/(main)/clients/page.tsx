...
import AdminClientTable from "@/components/admin/clients/AdminClientTable";
...
export default function AdminClientsPage() {
  ...
  return (
    <div className="flex w-full flex-col min-h-0">
      {/* Hero: mismo estilo que /admin/dashboard y /admin/users */}
      <section
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm sm:text-base max-w-xl" style={{ color: "var(--platform-fg-muted)" }}>
                Gestioná empresas e individuos. Creá clientes, asigná planes y administrá usuarios por cliente.
              </p>
            </div>
          </div>
          <Button
      ...
      <AdminClientTable search={search} filter={filter} />
    </div>
  );
}
