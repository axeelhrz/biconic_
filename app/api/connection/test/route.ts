        ...
        Firebird.attach(options, (err: Error | null, db: { detach?: (cb: (e: Error | null) => void) => void }) => {
          if (err) {
            ...
            if (msg.includes("ECONNREFUSED")) {
              ...
              friendly = "No se pudo abrir la base Firebird. Si antes conectaba, puede que en el servidor se haya reiniciado el servicio, se haya movido el archivo o el alias ya no exista. Probá con la ruta completa en el servidor (ej. /var/lib/firebird/data/fbcdistribuciones.fdb) o confirmá con el administrador el path o alias.";
            }
            resolve(
