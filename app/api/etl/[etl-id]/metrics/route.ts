...
function buildWidgetAggregationConfig(m: SavedMetricPayload): Record<string, unknown> {
  ...
  return {
    ...
    labelVisibilityMaxCount: cfg.labelVisibilityMaxCount,
    showDataLabels: cfg.showDataLabels,
    chartLegendPosition: cfg.chartLegendPosition,
    chartLegendVisible: cfg.chartLegendVisible,
    chartDoughnutCutout: cfg.chartDoughnutCutout,
    pieLegendVisible: cfg.pieLegendVisible,
    pieLegendResponsive: cfg.pieLegendResponsive,
    pieLegendMode: cfg.pieLegendMode,
    ...
    dashboardCompareUi: (cfg as { dashboardCompareUi?: unknown }).dashboardCompareUi,
    ...
    mapColorMid: cfg.mapColorMid,
    mapColorHigh: cfg.mapColorHigh,
    mapColorStops: cfg.mapColorStops,
    mapChoroplethPalette: cfg.mapChoroplethPalette,
    mapChoroplethScaleMode: cfg.mapChoroplethScaleMode,
    mapRadiusMin: cfg.mapRadiusMin,
    mapRadiusMax: cfg.mapRadiusMax,
    mapFillOpacityMin: cfg.mapFillOpacityMin,
    ...
    mapChoroplethLabelSize: cfg.mapChoroplethLabelSize,
