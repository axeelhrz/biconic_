        ...
        Tables: {
            ...
            connection_has_permissions: {
                Row: {
                    ...
                    created_at: string | null;
                    id: string;
                    permission_type: Database["public"]["Enums"]["app_permission_type"] | null;
                };
                Insert: {
                    client_member_id?: string | null;
                    connection_id?: string | null;
...
export declare const Constants: {
    ...
    readonly public: {
        readonly Enums: {
            readonly app_permission_type: readonly ["VIEW", "UPDATE"];
            readonly app_role: readonly ["APP_ADMIN", "CREATOR", "VIEWER"];
            readonly billing_interval: readonly ["month", "year"];
            readonly client_member_permission_types: readonly ["VIEW", "UPDATE"];
            readonly client_role: readonly ["admin", "editor", "viewer"];
            readonly client_type: readonly ["empresa", "individuo"];
            readonly etl_run_status: readonly ["started", "running", "completed", "failed"];
            readonly subscription_status: readonly ["trialing", "active", "past_due", "canceled", "incomplete", "expired"];
        };
    };
};
export {};
