...
export default function ConnectionsFilterBar({
  onSearchChange,
  onFilterChange,
  ...
  return (
    <div className="flex w-full items-center justify-between gap-5">
      ...
      {/* --- Barra de Búsqueda --- */}
      <div className="flex h-[34px] flex-1 items-center gap-2.5 rounded-xl border border-[#D9DCE3] bg-white pr-4 max-w-[450px]">
